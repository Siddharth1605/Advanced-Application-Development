...
function Payment() {
  ...
  return (
    ...
    <div style={{ backgroundColor:'#0B2447',padding: '20px', borderRadius: '10px' }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ marginBottom: '25px' }}>
          <label htmlFor="tot_amt"  style={{ fontSize: '0.875rem', fontWeight: '600', color: 'white' }}>Total Amount</label>
          <input
            id="tot_amt"
            name="tot_amt"
            type="number"
        ...
        <div style={{ marginBottom: '25px' }}>
          <label htmlFor="b_id"  style={{ fontSize: '0.875rem', fontWeight: '600', color: 'white'}}>Booking ID</label>
          <input
            id="b_id"
            name="b_id"
            type="number"
        ...
        <div style={{ marginBottom: '25px' }}>
          <label htmlFor="mod" style={{ fontSize: '0.875rem', fontWeight: '600', color: 'white'}}>Mode Of Payment</label>
          <select
                            id="mod"
                            name="mop"
        ...
        <div style={{ marginBottom: '25px' }}>
          <label htmlFor="p_date" style={{ fontSize: '0.875rem', fontWeight: '600', color: 'white' }}>Paymet Date</label>
          <input
            id="p_date"
            name="p_date"
            type="date"
