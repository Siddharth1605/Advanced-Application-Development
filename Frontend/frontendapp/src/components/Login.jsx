    ...
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh', padding: '0 20px' }}>
      <div style={{ maxWidth: '400px', width: '100%', backgroundColor: '#fff', padding: '40px', borderRadius: '8px', boxShadow: '0px 4px 10px rgba(0, 0, 0, 0.1)' }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px'}}>
          ...
          <div>
            <label htmlFor="confirmPassword" style={{ fontSize: '0.875rem', fontWeight: '500', color: '#333' }}>Confirm Password</label>
            <input
              id="confirmPassword"
              ...
              style={{ width: '100%', padding: '10px', borderRadius: '4px', border: '1px solid #ccc' }}
            />
            {!isFormValid && password !== confirmPassword && <p style={{ color: 'red', fontSize: '0.875rem' }}>Passwords do not match</p>}
          </div>
          <div>
            <button
              type="submit"
